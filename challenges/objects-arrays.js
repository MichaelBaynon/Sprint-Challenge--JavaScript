...
const universities = graduates.map(function (banana) {
  return banana.university
})
...
const contactInfo = graduates.map(function (banana) {
  return banana.first_name + ', ' + banana.email
});
...
const uni = graduates.filter(function (banana) {
  return banana.university === 'Uni'
});
console.log(uni);
...
*/
const animalNames = zooAnimals.forEach(function (potato) {
  console.log(potato.scientific_name, potato.animal_name);
});
...
const lowerCase = zooAnimals.map(function (potato) {
  return potato.animal_name.toLowerCase()
});
...
*/
const largerPopulation = zooAnimals.filter(function (potato) {
  return potato.population < 5
});
...
*/
const populationTotal = zooAnimals.reduce(function (total, potato) {
  return total + potato.population
}, 0);
