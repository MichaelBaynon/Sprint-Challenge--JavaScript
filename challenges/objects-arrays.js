...
console.log(tyrannosaurusInfo.weight);

// What was the diet of a velociraptor?
console.log(velociraptorInfo.diet);

// How long was a stegosaurus?
console.log(stegosaurusInfo.length);

// What time period did tyrannosaurus live in?
console.log(tyrannosaurusInfo.period);
...
graduates.forEach(universityInfo);

function universityInfo(universities) {
...
*/
let animalNamesScientificNames = function () {
  console.log(zooAnimals.animal_name, zooAnimals.scientific_name)
}
zooAnimals.forEach(animalNamesScientificNames)
...
const lowerCase = zooAnimals.filter(n => n >= 0);
lowerCase.map(n => 'animal_name')
...
*/
const largerPopulation = zooAnimals.population.filter(value => value < 5);
